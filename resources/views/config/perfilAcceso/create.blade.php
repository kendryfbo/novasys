...
@section('content')
	...
	<div id="vue-app" class="box box-solid box-default">
		...
		<div class="box-body">
			...
			<!-- form-horizontal -->
			<form  id="create" class="form-horizontal" method="post" action="{{route('guardarPerfilAcceso')}}">
		        ...
		        <div class="form-group">
		          ...
		          <div class="col-lg-2">
		            <input type="text" class="form-control input-sm" name="nombre" placeholder="Nombre del Perfiol..." value="{{ Input::old('nombre')}}" required>
		          </div>
		        </div>
				...
				<div class="form-group">
					...
					<div class="col-lg-5">
						<input type="text" class="form-control input-sm" name="descripcion" placeholder="Descripcion del Perfil..." value="{{ Input::old('descripcion')}}" required>
					</div>
...
<script src="{{asset('js/config/createPerfilAcceso.js')}}"></script>
@endsection
