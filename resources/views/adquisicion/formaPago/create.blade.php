...
@section('content')
	...
	<div id="vue-app" class="box box-solid box-default">
		...
		<div class="box-header text-center">
			<h4>Crear Condicion de Pago</h4>
		</div>
		<!-- /box-header -->
		<!-- box-body -->
		<div class="box-body">
			<!-- form -->
			<form  id="create" method="post" action="{{route('guardarFormaPagoProveedor')}}">
				...
				<div class="form-horizontal">
					...
					<div class="form-group">
						...
						<div class="col-sm-1">
							<input type="number" class="form-control" name="dias" placeholder="dias..." value="{{ Input::old('dias') ? Input::old('dias') : '' }}" required>
						</div>
					</div>
