		...
		<div class="box-body">
			...
			<form id="create" class="form-horizontal" action="{{route('guardarPlanProduccion')}}" method="post">
				...
				<div class="form-group">
					...
					<div class="col-lg-1">
						<select class="selectpicker" data-width="100%" data-live-search="true" data-style="btn-sm btn-default" name="diaSemana" v-model="dia">
										<option value="">Seleccione</option>
									@foreach ($dias as $dia)
					...
					<div class="col-lg-1">
						<input class="form-control input-sm" type="text" name="destino" v-model="destino" value="">
					</div>
