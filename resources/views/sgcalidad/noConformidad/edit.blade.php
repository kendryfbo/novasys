...
@section('content')
	<div class="box box-solid box-default">
		<div class="box-header text-center">
			<h3>Responder No Conformidad</h3>
		</div>
	<div class="box-body text-center">
<form method="post" id="update" action="{{route('actualizarNoConformidad', $noconformidad->id)}}">
{{ csrf_field() }}
...
<div class="col-sm-8">
<textarea class="form-control" name="analisis_causa" maxlength="599" placeholder="" rows="5" style="overflow:auto;resize:none">{{$noconformidad->analisis_causa}}</textarea>
...
<div class="col-sm-8">
<textarea class="form-control" name="accion_propuesta" maxlength="599" placeholder="" rows="5" style="overflow:auto;resize:none">{{$noconformidad->accion_propuesta}}</textarea>
...
@endif
	<div class="box-footer">
		<input type="hidden" class="form-control" name="estado_id" value="2">
		<button form="update" class="btn btn-default pull-right" type="submit">Ingresar Respuesta</button>
	</div>
	</div>
</form>
