  ...
  <!-- box -->
	<div id="vue-app" class="box box-solid box-default">
		...
		<div class="box-header text-center">
			<h4>Autorizacion de Orden de Compra por Finanzas</h4>
		</div>
		<!-- /box-header -->
		<!-- box-body -->
		<div class="box-body">
        ...
        <div class=" col-sm-4 col-md-offset-8">
			<table class="table table-condensed table-bordered table-custom display" cellspacing="0" width="100%">
				...
				<tr>
					...
					<td class="input-td">
					<input class="form-control text-right" type="number" name="sub_total" value="{{$ordenCompra->sub_total}}" readonly>
					</td>
				</tr>
				<tr>
					<th class="bg-gray text-right">% DESC.:</th>
					<td class="input-td">
						<input form="create" class="form-control text-right" type="number" name="porc_desc" readonly>
					</td>
				</tr>
				<tr>
					<th class="bg-gray text-right">DESCUENTO:</th>
					<td class="input-td">
						<input class="form-control text-right" type="number" name="descuento" value="{{$ordenCompra->descuento}}" readonly>
					</td>
				</tr>
				<tr>
					<th class="bg-gray text-right">NETO:</th>
					<td class="input-td">
						<input class="form-control text-right" type="number" name="neto" value="{{$ordenCompra->neto}}" readonly>
					</td>
				</tr>
				<tr>
					<th class="bg-gray text-right">IMPUESTO:</th>
					<td class="input-td">
						<input form="create" class="form-control text-right" type="number" name="impuesto" value="{{$ordenCompra->impuesto}}" readonly>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="input-td">
						<input class="form-control text-right" type="number" name="total" value="{{$ordenCompra->total}}" readonly>
					</td>
				</tr>
	...
	<!-- forms -->
	<form id="authorize" action="{{route('autorizarFinanzasOC',['OrdenCompra' => $ordenCompra->id])}}" method="post">
		{{csrf_field()}}
	</form>
	<form id="unauthorize" action="{{route('desautorizarFinanzasOC',['OrdenCompra' => $ordenCompra->id])}}" method="post">
		{{csrf_field()}}
	</form>
	<!-- /forms -->
