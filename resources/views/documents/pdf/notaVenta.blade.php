        ...
        <table class="table table-total" width="200px">
            <tbody>
                <tr>
                    ...
                    <th class="text-right">{{number_format($notaVenta->sub_total,2)}}</th>
                </tr>
                <tr>
                    <th class="text-right">DESCUENTO :</th>
                    <th class="text-right">{{number_format($notaVenta->descuento,2)}}</th>
                </tr>
                <tr>
                    <th class="text-right">NETO :</th>
                    <th class="text-right">{{number_format($notaVenta->neto,2)}}</th>
                </tr>
                <tr>
                    <th class="text-right">IVA :</th>
                    <th class="text-right">{{number_format($notaVenta->iva,2)}}</th>
                </tr>
                <tr>
                    <th class="text-right">IABA :</th>
                    <th class="text-right">{{number_format($notaVenta->iaba,2)}}</th>
                </tr>
                <tr>
                    <th class="text-right">TOTAL :</th>
                    <th class="text-right">{{number_format($notaVenta->total,2)}}</th>
                </tr>
            </tbody>
        </table>
