		...
		<div class="box-body">
    		...
    		<form class="form-horizontal"  id="create" method="post" action="{{route('guardarNotaCreditoNac')}}">
                ...
                <div class="form-group form-group-sm">
                    ...
                    <div class="col-lg-1">
                        <input laceholder="Numero..." class="form-control input-sm" name="factura" type="number" min="0" value="{{$notaCredito->num_fact}}" readonly>
                    </div>
		        ...
		        <div class="form-group">
					...
					<div class="col-lg-4">
						<input class="form-control input-sm" type="text" name="cliente" value="{{$notaCredito->factura->cliente}}" readonly>
					</div>

					<label class="control-label col-lg-2">Condicion Pago:</label>
					<div class="col-lg-2">
						<input class="form-control input-sm" type="text" name="formaPago" value="{{$notaCredito->factura->cond_pago}}" readonly>
					</div>
