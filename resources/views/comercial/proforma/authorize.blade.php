  ...
  <!-- box -->
	<div id="vue-app" class="box box-solid box-default">
		...
		<div class="box-body">
			...
			<!-- form unauthorize-->
			<form id="authorize" action="{{route('autorizarProforma',['numero' => $proforma->numero])}}" method="post">
				{{csrf_field()}}
			</form>
			<!-- /form unauthorize-->
			<!-- form authorize-->
			<form id="unauthorize" action="{{route('desautorizarProforma',['numero' => $proforma->numero])}}" method="post">
				{{csrf_field()}}
			</form>
			<!-- /form authorize-->
        ...
        <div class="form-group">
			...
			<div class="col-lg-2">
				<input class="form-control input-sm" type="text" name="formaPago" value="{{$proforma->centro_venta}}" readonly>
			</div>
        ...
        <div class="form-group">
          ...
          <div class="col-lg-2">
			<input class="form-control input-sm" type="text" name="formaPago" value="{{$proforma->clau_venta}}" readonly>
          </div>
        ...
        <div class="form-group">
	          ...
	          <div class="col-lg-4">
				<input class="form-control input-sm" type="text" name="formaPago" value="{{$proforma->cliente->descripcion}}" readonly>
	          </div>
        ...
        <div class="form-group">
          ...
          <div class="col-lg-4">
			  <input class="form-control input-sm" type="text" name="formaPago" value="{{$proforma->puerto_emb}}" readonly>
          </div>

			<label class="control-label col-lg-2">Medio Transporte:</label>
			<div class="col-lg-2">
				<input class="form-control input-sm" type="text" name="formaPago" value="{{$proforma->transporte}}" readonly>
			</div>
