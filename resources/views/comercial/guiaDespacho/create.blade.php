			...
			<form  id="create" class="form-horizontal" method="post" action="{{route('guardarGuiaDespacho')}}">
				...
				<div class="form-group">
					...
					<div class="col-lg-2">
						...
						<input type="hidden" class="form-control input-sm" name="proforma" placeholder="Numero Proforma..." value="{{$proforma ? $proforma->numero:''}}" required>
					</div>
				...
				<div class="form-group">
				  ...
				  <div class="col-lg-3">
					  <select class="selectpicker" data-width="100%" data-live-search="true" data-style="btn-sm btn-default" name="aduana" required>
				...
				<div class="form-group">
				  ...
				  <label class="control-label col-lg-1" >Puerto Emb.:</label>
				  <div class="col-lg-3">
					  <select class="selectpicker" data-width="100%" data-live-search="true" data-style="btn-sm btn-default" name="puertoEmb" required>
						  <option value="">Seleccionar Puerto...</option>
						  @foreach ($puertosEmbarque as $puerto)
				...
				<div class="form-group">
					...
					<div class="col-lg-2">
						<input type="number" step="0.01" class="form-control input-sm" name="neto" placeholder="Peso Netos..." value="{{ Input::old('neto') ? Input::old('contacto') : '' }}" required>
					</div>

					<label class="control-label col-lg-1">K.Bruto:</label>
					<div class="col-lg-2">
						<input type="number" step="0.01" class="form-control input-sm" name="bruto" placeholder="Peso Bruto..." value="{{ Input::old('bruto') ? Input::old('bruto') : '' }}" required>
					</div>
