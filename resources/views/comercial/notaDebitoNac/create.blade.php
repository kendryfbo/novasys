  			...
  			<table class="table table-condensed table-bordered table-custom display" cellspacing="0" width="100%">
  					...
  					<tr>
  						...
  						<td class="input-td text-right">
							{{$notaCredito ? number_format($notaCredito->neto ,0,',','.'): ''}}
  						</td>
  					</tr>
					...
					<tr>
						...
						<td class="input-td text-right">
							{{$notaCredito ? number_format($notaCredito->iaba ,0,',','.'): ''}}
						</td>
					</tr>
  					...
  					<tr>
  						...
  						<td class="input-td text-right">
							{{$notaCredito ? number_format($notaCredito->iva ,0,',','.'): ''}}
  						</td>
  					</tr>
  					...
  					<tr>
  						...
  						<th class="bg-gray input-td text-right">
							{{$notaCredito ? number_format($notaCredito->total,0,',','.') : ''}}
  						</th>
  					</tr>
