	...
	<div id="vue-app" class="box box-solid box-default">
		...
		<div class="box-body">
			...
			<div class="btn-group pull-right">
					<a class="btn btn-primary btn-sm" href="{{route('crearNotaDebitoNac')}}">
						Crear
					</a>
			</div>
		</div>
					...
					@foreach ($notasDebito as $nota)
						<tr>
							...
							<td class="text-center">
								<form style="display: inline" action="{{route('eliminarNotaDebitoNac', ['notaDebito' => $nota->id])}}" method="post">
									{{csrf_field()}}
									{{ method_field('DELETE') }}
