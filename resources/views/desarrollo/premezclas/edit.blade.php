		...
		<form id="create" method="post" action="{{route('actualizarPremezcla',['premezcla' => $premezcla->id])}}">
			...
			<div class="form-horizontal">
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="text" v-model='codigo' class="form-control" name="codigo" placeholder="Codigo de Premezcla..." value="{{ $premezcla->codigo }}" readonly required>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input type="text" v-model='descripcion' class="form-control" name="descripcion" placeholder="Descripcion de Producto..." value="{{ $premezcla->descripcion }}" readonly required>
					</div>
			...
			<div class="form-horizontal">
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="checkbox" name="activo" data-toggle="toggle" data-on="Si" data-off="No" data-size="small" {{ $premezcla->activo ? "checked" : "" }}>
					</div>
				</div>
			</div>
