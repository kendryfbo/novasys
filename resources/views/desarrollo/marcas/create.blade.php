    ...
    <div class="box-body">
		...
		<form id="create" class="form-horizontal" method="post" action="{{route('guardarMarca')}}">
	        ...
	        <div class="form-group">
			  ...
			  <div class="col-sm-8">
	            <select class="form-control js-select2-basic" name="familia" id="tipo-select">
			...
			<div class="form-group">
			  ...
			  <div class="col-sm-8">
				<input type="checkbox" class="control-label" name="ila" data-toggle="toggle" data-on="Si" data-off="No" data-size="small" {{ Input::old('ila') ? "checked" : "" }}>
			  </div>
			</div>
			<div class="form-group">
