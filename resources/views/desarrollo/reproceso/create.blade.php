...
<div id="vue-app" class="box box-solid box-default">
	...
	<div class="box-header text-center">
      <h3 class="box-title">Crear Reproceso</h3>
    </div>
    <!-- /.box-header -->
	<!-- box-body -->
    <div class="box-body">
		<!-- form start -->
		<form id="create" method="post" action="{{route('guardarReproceso')}}">
			{{ csrf_field() }}
			...
			<div class="form-horizontal">
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="text" v-model='codigo' class="form-control" name="codigo" placeholder="Codigo de Reproceso..." value="{{ Input::old('codigo') ? Input::old('codigo') : $familia->codigo }}" readonly required>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input type="text" v-model='descripcion' class="form-control" name="descripcion" placeholder="Descripcion de Producto..." value="{{ Input::old('descripcion') ? Input::old('descripcion') : "REPROCESO" }}" readonly required>
					</div>
...
@section('scripts')
	...
	<script src="{{asset('js/desarrollo/reproceso.js')}}"></script>
@endsection
