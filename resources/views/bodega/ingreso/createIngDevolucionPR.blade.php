  ...
  <!-- box -->
	<div id="vue-app" class="box box-solid box-default">
		...
		<div class="box-header text-center">
			<h4>Ingreso Devolución de Premezcla</h4>
		</div>
		<!-- /box-header -->
		<!-- box-body -->
		<div class="box-body">
			...
			<form class="form-horizontal"  id="create" method="post" action="{{route('guardarIngDevolucionMP')}}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-5">
                        <input class="form-control input-sm" name="descripcion" type="text" value="devolución de Premezcla" required readonly>
                    </div>
...
@section('scripts')
	...
	<script src="{{asset('js/bodega/createIngManualPR.js')}}"></script>
@endsection
