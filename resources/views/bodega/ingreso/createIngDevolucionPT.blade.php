  ...
  <!-- box -->
	<div id="vue-app" class="box box-solid box-default">
		...
		<div class="box-header text-center">
			<h4>Ingreso Devolucion Producto Terminado</h4>
		</div>
		<!-- /box-header -->
		<!-- box-body -->
		<div class="box-body">
			...
			<!-- form -->
			<form class="form-horizontal"  id="create" method="post" action="{{route('guardarIngDevolucionMP')}}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-5">
                        <input class="form-control input-sm" name="descripcion" type="text" value="devolución Producto Terminado" required readonly>
                    </div>
...
@section('scripts')
	...
	<script src="{{asset('js/bodega/createIngManualPT.js')}}"></script>
@endsection
