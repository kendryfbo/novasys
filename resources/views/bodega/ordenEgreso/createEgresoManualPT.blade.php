  ...
  <!-- box -->
	<div id="vue-app" class="box box-solid box-default">
		...
		<div class="box-header text-center">
			<h4>Egreso Manual Producto Terminado</h4>
		</div>
		<!-- /box-header -->
		<!-- box-body -->
		<div class="box-body">
			...
			<!-- form -->
			<form class="form-horizontal"  id="create" method="post" action="{{route('guardarEgresoManualPT')}}">
...
@section('scripts')
	...
	<script src="{{asset('js/bodega/ordenEgreso/createEgresoManualPT.js')}}"></script>
@endsection
