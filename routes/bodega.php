...
Route::prefix('bodega')->group( function() {
    ...
    // Reportes
    Route::get('/buscaLote',        'Bodega\BodegaReportController@indexBuscaLote')->name('buscaLote');
    Route::post('/buscaLote',       'Bodega\BodegaReportController@indexBuscaLote')->name('buscaLote');
